...
namespace Tricksfor.Blockchain.Booster.Services
{
    /// <summary>
    ...
    /// </summary>
    public class BoosterStakingService
    {
        private readonly IWeb3 _web3;
        private readonly string _contractAddress;

        public BoosterStakingService(IWeb3 web3, string contractAddress)
        {
            _web3 = web3;
        ...
        public Task<string> OwnerQueryAsync()
            => _web3.Eth.GetContractQueryHandler<StakingOwnerFunction>()
                .QueryAsync<string>(_contractAddress, new StakingOwnerFunction());

        public Task<bool> PausedQueryAsync()
            => _web3.Eth.GetContractQueryHandler<StakingPausedFunction>()
                .QueryAsync<bool>(_contractAddress, new StakingPausedFunction());
        ...
        public Task<TransactionReceipt> PauseRequestAndWaitForReceiptAsync()
            => _web3.Eth.GetContractTransactionHandler<StakingPauseFunction>()
                .SendRequestAndWaitForReceiptAsync(_contractAddress, new StakingPauseFunction());

        public Task<TransactionReceipt> UnpauseRequestAndWaitForReceiptAsync()
            => _web3.Eth.GetContractTransactionHandler<StakingUnpauseFunction>()
                .SendRequestAndWaitForReceiptAsync(_contractAddress, new StakingUnpauseFunction());
        ...
        {
            var eventHandler = _web3.Eth.GetEvent<TokenStakedEventDTO>(_contractAddress);
            // Type arguments: <staker address (null = any staker), tokenId (indexed filter)>
