...
namespace Tricksfor.Blockchain.Booster.Contracts.Functions
{
    ...
    public class NftPausedFunction : FunctionMessage { }
    ...
    public class NftTransferFromFunction : FunctionMessage
    {
    ...
    [Function("pause")]
    public class NftPauseFunction : FunctionMessage { }

    [Function("unpause")]
    public class NftUnpauseFunction : FunctionMessage { }
}
